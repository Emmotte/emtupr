...
// If you don't have it installed, we may need to use standard GSAP animations.
// For now, we will attempt to use it as provided.
    ...
    const onMove = (e: MouseEvent) => {
      ...
      for (const dot of dotsRef.current) {
        ...
        if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
          ...
          // Use standard GSAP since InertiaPlugin might not be available
          gsap.to(dot, {
            xOffset: pushX,
            yOffset: pushY,
            duration: 0.5,
